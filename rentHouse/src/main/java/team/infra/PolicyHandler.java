...
public class PolicyHandler {
    ...
    @StreamListener(
        ...
        condition = "headers['type']=='BikeArrivaled'"
    )
    public void wheneverBikeArrivaled_BikeConditionChange(
        @Payload BikeArrivaled bikeArrivaled
    ) {
    ...
    @StreamListener(
        value = KafkaProcessor.INPUT,
        condition = "headers['type']=='BicycleRepaired'"
    )
    public void wheneverBicycleRepaired_BikeConditionChange(
        @Payload BicycleRepaired bicycleRepaired
    ) {
        BicycleRepaired event = bicycleRepaired;
        System.out.println(
            "\n\n##### listener BikeConditionChange : " +
            bicycleRepaired +
            "\n\n"
        );
    ...
    public void wheneverReturned_BikeConditionChange(
